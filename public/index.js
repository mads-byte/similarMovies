    ...
    searchResults.forEach(movie => {
        ...
        movieDiv.addEventListener('click', async () => {
            ...
            similarMovieResults.forEach(simMovie => {
                ...
                simMovieCard.innerHTML = `<div style="height: 231px; width: 154px; background-color: #04CD6C; margin: auto"><img style="height: 231px; width: 154px; object-fit: fill;" src="https://image.tmdb.org/t/p/w154/${simMovie.poster_path}"></div><div>${simMovie.title}</div><div>${simMovie.release_date}</div><div>${overview}</div>`
